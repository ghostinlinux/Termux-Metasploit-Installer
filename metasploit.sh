...
curl -LO https://raw.githubusercontent.com/ghostinlinux/Termux-Metasploit-Installer/main/database.yml
...
cd ${PREFIX}/bin && curl -LO https://github.com/ghostinlinux/Termux-Metasploit-Installer/blob/main/msfconsole && chmod +x msfconsole
